...
BUILDTOOLS_TO_USE=$(realpath /home/arne/openvstorage/volumedriver-buildtools/rtchecked)

VOLUMEDRIVER_DIR=/home/arne/github/volumedriver-core

. ${VOLUMEDRIVER_DIR}/src/buildscripts/get_revision.sh
BUILD_DIR=/home/arne/builds/volumedriver/rtchecked
export RUN_TESTS=yes
export CLEAN_BUILD=no
export RECONFIGURE_BUILD=no
export TEMP=${TEMP:-${VOLUMEDRIVER_DIR}/tmp}
export FOC_PORT_BASE=${FOC_PORT_BASE:-19150}
