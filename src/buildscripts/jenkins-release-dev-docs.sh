...
export FOC_PORT_BASE=${FOC_PORT_BASE:-19300}
export BUILD_DEBIAN_PACKAGES=no
export BUILD_DOCS=yes
...
export DOCS_UPLOAD=yes
export DOCS_SERVER="root@172.19.7.1"
export DOCS_PATH="/var/www/openvstorage.com/doxygen.openvstorage.com/htdocs/`cd $VOLUMEDRIVER_DIR && hg branch`/"
