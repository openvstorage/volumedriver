...
CXX_DEFINES="${CXX_DEFINES} -DBOOST_FILESYSTEM_VERSION=3 -DBOOST_ASIO_HAS_STD_CHRONO -DBOOST_THREAD_PROVIDES_FUTURE -DBOOST_THREAD_PROVIDES_FUTURE_CONTINUATION -DBOOST_THREAD_PROVIDES_EXECUTORS -DBOOST_THREAD_PROVIDES_FUTURE_WHEN_ALL_WHEN_ANY -DBOOST_THREAD_PROVIDES_FUTURE_UNWRAP"
