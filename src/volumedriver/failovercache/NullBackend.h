...
#ifndef DTL_NULL_BACKEND_H_
#define DTL_NULL_BACKEND_H_
...
public:
    ...
    NullBackend&
    operator=(const NullBackend&) = delete;
...
private:
    DECLARE_LOGGER("DtlNullBackend");

    using Entry = std::vector<volumedriver::FailOverCacheEntry>;
